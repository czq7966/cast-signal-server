...
module.exports = env => {
    ...
    const distDir = path.resolve(__dirname, '../dist/desktop/loading/web');
    const srcDir =  path.resolve(__dirname, '../src/desktop/loading/web');
    ...
    plugins.push(
        new CopyWebpackPlugin([
            ...
            {
                from: path.resolve(srcDir, 'config.json'),
                to: 'config.json',
            }                                  
        ]),        
    )
