...
module.exports = env => {
    ...
    const distDir = path.resolve(__dirname, '../dist/desktop/loading/app');
    const srcDir =  path.resolve(__dirname, '../src/desktop/loading/app');
    entry['index'] = path.resolve(srcDir, "index.ts");
    entry['preload'] = path.resolve(srcDir, "preload.ts");
